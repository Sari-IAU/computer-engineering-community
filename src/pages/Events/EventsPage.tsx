...
export default function EventsPage() {
  ...
  const [locationType, setLocationType] = useState<"همه" | "حضوری" | "آنلاین">(
    "همه"
  );
    ...
    result.sort((a, b) => {
      let factorA =
        sortField === "id"
          ? a.id
          : sortField === "capacity"
          ? a.capacity - a.registered
          : a.registered;
      let factorB =
        sortField === "id"
          ? b.id
          : sortField === "capacity"
          ? b.capacity - b.registered
          : b.registered;
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <aside className="w-full lg:w-80 flex flex-col gap-4">
            ...
            >
              ...
              <div
                className={`transition-all duration-300 overflow-hidden ${
                  openSection.categories ? "max-h-60 border-t" : "max-h-0"
                }`}
                      ...
                      style={{
                        backgroundColor:
                          activeCategory === cat
                            ...
                            : "transparent",
                        color:
                          activeCategory === cat ? "#ffffff" : "var(--text)",
                      }}
                      onMouseEnter={(e) =>
                        activeCategory !== cat &&
            ...
            >
              ...
              <div
                className={`transition-all duration-300 overflow-hidden ${
                  openSection.location ? "max-h-40 border-t" : "max-h-0"
                }`}
                style={{ borderColor: "var(--border)" }}
              >
                <div className="p-4 flex flex-col gap-1.5">
                      ...
                      style={{
                        backgroundColor:
                          locationType === type
                            ...
                            : "transparent",
                        color:
                          locationType === type ? "#ffffff" : "var(--text)",
                      }}
                      onMouseEnter={(e) =>
                        locationType !== type &&
                        (e.currentTarget.style.backgroundColor =
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                ...
                <CustomSelect
                  ...
                  options={[
                    { label: "تاریخ انتشار", value: "id" },
                    { label: "ظرفیت باقی‌مانده", value: "capacity" },
                    { label: "تعداد ثبت‌نامی", value: "registered" },
                  ]}
                />
