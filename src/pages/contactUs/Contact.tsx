      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-10">
        ...
        <section className="text-center flex flex-col items-center gap-3">
          ...
          <h1 className="font-black text-2xl md:text-4xl" style={{ color: "var(--text-h)" }}>
            با ما در <span style={{ color: "var(--accent)" }}>ارتباط</span> باشید
          </h1>
          <p className="text-sm text-slate-400 dark:text-slate-400 max-w-xl leading-relaxed font-medium">
            نظرات، پیشنهادات یا سوالات خود را از طریق راه‌های زیر یا فرم زیر با ما در میان بگذارید.
          </p>
        </section>

        {/* ================= کارت‌های اطلاعات تماس (Grid کاملاً هماهنگ با بخش افتخارات) ================= */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            <div className="p-3 rounded-xl flex-shrink-0" style={{ backgroundColor: "var(--accent-bg)" }}>
              <MapPin className="w-5 h-5" style={{ color: "var(--accent)" }} />
            </div>
            <div className="flex flex-col gap-1 text-right">
              <span className="text-[11px] font-bold" style={{ color: "var(--text)" }}>مراجعه حضوری</span>
              <span className="text-xs md:text-sm font-bold" style={{ color: "var(--text-h)" }}>
          ...
          >
            ...
            <div className="flex flex-col gap-1 text-right">
              <span className="text-[11px] font-bold" style={{ color: "var(--text)" }}>ارتباط ایمیلی</span>
              <a 
        ...
        {/* ================= فرم پیام جدید: عریض، یکپارچه و فوق‌العاده مدرن ================= */}
        <form 
        ...
        >
          <div className="flex items-center gap-2 mb-2 pb-3 border-b" style={{ borderColor: "var(--border)" }}>
            ...
            <h2 className="font-extrabold text-base sm:text-lg m-0" style={{ color: "var(--text-h)" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-2 text-right">
              <label className="text-xs font-bold" style={{ color: "var(--text-h)" }}>
                پست الکترونیک
              </label>
              <input
                type="email"
            ...
            {/* در صورت نیاز می‌توانید یک فیلد نام یا موضوع هم اینجا اضافه کنید، فعلاً تکی برای تقارن دسکتاپ */}
            <div className="flex flex-col gap-2 text-right">
              <label className="text-xs font-bold" style={{ color: "var(--text-h)" }}>
                نوع درخواست
              </label>
          ...
          {/* دکمه ارسال شیک با رنگ ته‌مایه زرد/نارنجی تصویر دوم شما */}
          {/* دکمه ارسال هماهنگ با رنگ اکسنت (بنفش لایت / آبی دارک) */}
<button
  type="submit"
