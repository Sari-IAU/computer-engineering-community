            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                ...
                <CustomSelect
                  ...
                  options={[
                    { label: "جدیدترین مقالات", value: "id" },
                    { label: "مدت زمان مطالعه", value: "readTime" },
                  ]}
                />
                  ...
                  >
                    ...
                    <div
                      className={`relative overflow-hidden bg-gradient-to-br ${
                        ...
                        viewMode === "grid"
                          ? "w-full h-40"
                          : "w-full sm:w-48 h-36 rounded-xl flex-shrink-0"
                    ...
                    <div className="p-5 flex-1 flex flex-col gap-4 w-full">
                      ...
                      <div
                        className="flex flex-wrap items-center gap-x-4 gap-y-2 text-[11px] font-bold border-t pt-3 mt-auto"
                        style={{
                          borderColor: "var(--border)",
                          color: "var(--text)",
                        }}
