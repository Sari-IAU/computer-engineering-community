...
export default function AboutPage() {
  const stats = [
    {
      id: 1,
      label: "کارگاه و رویداد برگزار شده",
      value: "+۴۰",
      icon: BookOpen,
    },
    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-20">
        ...
        <section className="text-center flex flex-col items-center gap-4">
          ...
          <p
            className="text-sm md:text-base max-w-2xl leading-relaxed font-medium"
            style={{ color: "var(--text)" }}
          >
            محیطی پویا برای اشتراک‌گذاری دانش، تجربه و ساخت پروژه‌های واقعی. ما
            به دانشجویان کمک می‌کنیم تا مسیر شغلی و علمی خود را در دنیای مهندسی
            کامپیوتر پیدا کنند.
          </p>
        </section>
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              ...
              <h2
                ...
                style={{ color: "var(--text-h)" }}
              >
                سابقه و داستان تشکیل
              </h2>
            </div>
            <p
              className="text-xs md:text-sm leading-relaxed font-medium text-justify"
              style={{ color: "var(--text)" }}
            >
              انجمن علمی مهندسی کامپیوتر از سال‌های گذشته با تلاش دانشجویان
              علاقه‌مند و هدایت اساتید دپارتمان شکل گرفت. هدف اولیه ما، پر کردن
              خلاءهای مهارتی و ایجاد بستر مناسب برای کسانی بود که می‌خواستند
              فراتر از سرفصل‌های مصوب دانشگاهی قدم بردارند.
            </p>
            <p
              className="text-xs md:text-sm leading-relaxed font-medium text-justify"
              style={{ color: "var(--text)" }}
            >
              امروز پس از برگزاری ده‌ها هکاتون، سمینار تخصصی و کارگاه‌های فشرده،
              این انجمن به یکی از فعال‌ترین تشکل‌های علمی دانشگاه تبدیل شده است.
            </p>
          </div>
        ...
        <section className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: "توسعه پروژه‌های تیمی",
                desc: "هدایت دانشجویان به سمت ساخت پروژه‌های دنیای واقعی و ترویج فرهنگ سورس‌باز.",
              },
              {
                title: "برگزاری مسابقات تخصصی",
                desc: "ایجاد شور و نشاط علمی میان دانشجویان از طریق برگزاری مینی‌هکاتون‌ها و چالش‌های هفتگی.",
              },
              {
                title: "آمادگی برای صنعت و بازار",
                desc: "ارائه آموزش‌های لازم پیرامون مهارت‌های نرم، رزومه‌نویسی، گیت و تکنولوژی‌های به‌روز.",
              },
            ].map((item, index) => (
              <div
                key={index}
